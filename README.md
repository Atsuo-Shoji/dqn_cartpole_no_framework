...
<BR>
| 未訓練モデルでPlay（10ステップ程度ですぐに倒れます） | 訓練済モデルでPlay（上限200ステップいっぱい粘ります）<br>Multi-step Learning n=2で訓練 |
|      :---:       |     :---:      |
...
エピソードの”成功”条件と報酬は、以下の通りです。<BR>
※下記「閾値」：訓練関数train()の引数「steps_success_over」で、既定値は160
| エピソード成功/失敗| 条件| 報酬 |
|     :---:     |     :---:      | :---         | 
